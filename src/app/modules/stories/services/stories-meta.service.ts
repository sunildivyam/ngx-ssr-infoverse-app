...
import { storiesMetaInfo } from '../constants/stories-meta.constants';

@Injectable({
  providedIn: 'root'
})
export class StoriesMetaService {
  ...
  public setStoriesPageMeta(pageName: StoriesMetaInfoEnum): MetaInfo {
    let { title, description, keywords } = storiesMetaInfo[pageName];
